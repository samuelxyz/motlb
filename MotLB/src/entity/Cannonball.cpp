...
namespace entity
{
  ...
  void Cannonball::explode()
  {
    ...
    Flash* flash = new Flash(battle, position, 30, 3, Values::Color{ 1.0f, 1.0f, 0.6f, 1.0f },
        Values::Color{ 1.0f, 0.8f, 0.8f, 0.1f }, 20);

    battle->add(flash);

    // make smoke ring
    const unsigned int smokeCount = Values::random(20, 30);
